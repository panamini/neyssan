...
>
> **For PR1 / PR3-PR8 (structural refactors after DS-v2):** see [REFONTE-AUDIT.md](./REFONTE-AUDIT.md).
>
> **For final navigation + per-page architecture:** see [APP-SKELETON.html](./APP-SKELETON.html). Open it in a browser. It mocks the entire app (collapsed sidebar, ⌘K palette, document-first proposal/CV forge, split-view jobs, settings sub-routes, library, sign-in, templates, onboarding) using only DS-v2 primitives. Click around to test navigation. **This is the visual target for PR3-PR8.**
>
> **For features to keep / restore / remove during the refactor:** see [FEATURES-KEEP-VS-REMOVE.md](./FEATURES-KEEP-VS-REMOVE.md). Before deleting any old behavior, check this doc.
