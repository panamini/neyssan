...
- [2026-04-16-proposal-style-persistence-and-saved-view-debugging.md](/Volumes/video/kay/app/pouraurelien/save/implementation_UI/neyssan/docs/dev/2026-04-16-proposal-style-persistence-and-saved-view-debugging.md)
...
```text
compose form state
-> ProposalForge page style state
...
```text
route /proposal?view=saved&id=...
-> sortedSavedProposals
-> openedSavedProposal
-> savedProposalRenderMetadata / selectedRenderState
-> ProposalDisplay
-> actual DOM fonts/layout/palette
```
...
```text
openedSavedProposal
-> restore content + source brief + style state into live draft
-> writeStoredProposalOutputDraft(...)
-> writeStoredProposalComposeDraft(...)
-> compose workspace renders via ProposalDisplay
```
