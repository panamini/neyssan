 ...
 */
// pipeline-note: This is the choke-point for all background LLM parsing work.
// Keep job lifecycle + telemetry wiring here so hybridParser/canonicalize stay
// agnostic of scheduling concerns.
