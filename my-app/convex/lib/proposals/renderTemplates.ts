...
export const PROPOSAL_TEMPLATE_DEFINITIONS: readonly ProposalTemplateDefinition[] =
  [
    ...
    {
      id: "modernist_signal",
      name: "French Correspondence",
      shortLabel: "European layout · ATS",
      description:
        "A canonical European correspondence layout with a linear ATS reading order, French editorial discipline, and restrained Workshop contrast. It respects the user's saved page format.",
      twinLabel: "French",
      exportShell: "onecol",
      leftMarginMm: 25.4,
      leftZoneMm: 17,
    ...
    },
    {
      ...
      name: "Minimal Business Letter",
      shortLabel: "US layout · ATS",
      description:
        "A canonical US business-letter layout with a linear ATS reading order, premium restraint, and the Workshop 17/18 cadence. It respects the user's saved page format.",
      twinLabel: "Minimal",
