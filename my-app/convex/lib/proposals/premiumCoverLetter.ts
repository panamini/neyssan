...
export const MISTRAL_PREMIUM_COVER_LETTER_ADAPTER = [
  ...
  "",
  "MISTRAL ADJACENT-FIT ADDENDUM",
  "",
  "Apply this section when candidate evidence is adjacent but not exact.",
  "",
  "Adjacent evidence means:",
  "- the candidate facts show related work, nearby workflows, support exposure, monitoring, documentation, reporting, coordination, collaboration, or work from the relevant side;",
  ...
  "- my experience in [JD term], if the candidate facts do not use or support that capability",
  "",
  "Do not write:",
  "- \"My background directly aligns with your need for emergency preparedness.\"",
  "- \"I can manage safety incidents.\"",
  "- \"I have direct experience in healthcare security.\"",
  "- \"I am ready to lead emergency readiness.\"",
  "- \"My experience matches your need for incident response.\"",
  "- \"I bring the required experience for emergency preparedness.\"",
  "- \"I am qualified for every security requirement in the role.\"",
  "",
  "Allowed adjacent phrasing:",
  "- \"My background is closest to the [CV-backed area] side of this work.\"",
  "- \"My experience is relevant through [CV-backed action/responsibility].\"",
  "- \"I have worked from the [CV-backed area] side of this kind of work.\"",
  "- \"I have supported related workflows involving [CV-backed term].\"",
  "- \"I have contributed to work adjacent to [CV-backed term].\"",
  "- \"I have monitored, documented, or reported work where [role-side concern] mattered.\"",
  "- \"I can support the execution layer around [JD term] when ownership sits with the appropriate team.\"",
  "- \"That experience would be useful in a role where [JD-backed responsibility] depends on clear documentation, monitoring, reporting, or follow-through.\"",
  "",
  "JD terminology rule:",
  "- You may use JD terms as role context.",
  "- You may not use JD terms as candidate experience unless the candidate facts support that exact capability.",
  "- If the JD term is not candidate-backed, attach it to the employer-side role, not to the candidate.",
  "- Do not use the JD's exact terminology inside a candidate claim unless the candidate facts use the same term or clearly equivalent wording.",
  "",
  "Good:",
  "\"My background is closest to the monitoring and documentation side of campus safety, where clear reporting and steady presence matter.\"",
  "",
  "Good:",
  "\"I have protected VIP individuals, monitored secure environments, and kept routine status reports current. That experience is relevant to a Security Officer role where daily coverage and incident documentation matter.\"",
  "",
  "Good:",
  "\"I can support emergency-readiness workflows through careful monitoring, reporting, and documentation, without claiming ownership of emergency preparedness drills.\"",
  "",
  "Bad:",
  "\"I have direct experience managing safety incidents.\"",
  "",
  "Bad:",
  "\"I am ready to lead emergency preparedness drills.\"",
  "",
  "Bad:",
  "\"My background directly aligns with Ascension's healthcare security mission.\"",
  "",
  "Ownership rule:",
  "If the candidate evidence is adjacent, default to low-ownership verbs:",
  "- supported",
  "- monitored",
  "- documented",
  "- reported",
  ...
  "",
  "Do not use high-ownership verbs unless the candidate facts explicitly support them:",
  "- led",
  "- owned",
  "- managed",
  "- directed",
