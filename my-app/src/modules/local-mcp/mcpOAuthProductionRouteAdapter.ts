...
const PRE_AUTH_QUOTA_TIMEOUT_MS = MCP_PRODUCTION_OPERATION_TIMEOUT_MS;
const PRE_AUTH_CREATE_TIMEOUT_MS = MCP_PRODUCTION_OPERATION_TIMEOUT_MS;
const OWNER_BINDING_TIMEOUT_MS = MCP_PRODUCTION_OPERATION_TIMEOUT_MS;
const AUTHORIZATION_INTENT_CONSUME_TIMEOUT_MS = MCP_PRODUCTION_OPERATION_TIMEOUT_MS;
const AUTHORIZATION_CODE_CREATE_TIMEOUT_MS = MCP_PRODUCTION_OPERATION_TIMEOUT_MS;
const AUTHORIZATION_CODE_VALIDATE_TIMEOUT_MS = MCP_PRODUCTION_OPERATION_TIMEOUT_MS;
const ACCESS_TOKEN_ISSUE_TIMEOUT_MS = MCP_PRODUCTION_OPERATION_TIMEOUT_MS;
const ACCESS_TOKEN_VERIFY_TIMEOUT_MS = MCP_PRODUCTION_OPERATION_TIMEOUT_MS;
const READONLY_SUMMARY_EXECUTION_TIMEOUT_MS = MCP_PRODUCTION_OPERATION_TIMEOUT_MS;
