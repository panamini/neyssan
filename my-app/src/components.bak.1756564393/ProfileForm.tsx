                      ...
                      <div className="space-y-2">
                        ...
                        <div className="flex items-center gap-2">
                          <Button
                            ...
                            className="px-3 py-1 text-white bg-primary rounded"
                          >
                            Save</Button>
                          <Button
                            onClick={() =>{
                            ...
                            className="px-3 py-1 bg-surface-muted rounded"
                          >
                            Cancel</Button>
                          {status && <span className="text-sm">{status}</span>}
                        </div>
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap items-center gap-2">
                      {(currentProfile.skills || []).map((s: string, i: number) => (
                        <span key={i} className="flex items-center gap-2 px-2 py-1 text-xs bg-surface rounded-full dark:bg-gray-700">
                          <span>{s}</span>
                          <Button
