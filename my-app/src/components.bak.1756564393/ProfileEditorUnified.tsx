    ...
    <div className="max-w-4xl p-2 mx-auto bg-background text-foreground">
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        <Card className="p-2 border rounded-md bg-background border-accent">
          ...
          <pre className="p-2 overflow-auto text-sm border rounded-md bg-gray-50 h-72">
          ...
          <div className="flex gap-2 mt-3">
            ...
            <Button
              ...
              className="px-3 py-2 bg-surface rounded-md"
            >
              Refresh</Button>
          </div>
        ...
        <Card className="p-2 border rounded-md bg-background border-accent">
          ...
          <div>
            ...
            <Input
              ...
              className={`w-full px-2 py-1 border rounded-md ${missingFields.includes("name") ? "border-red-500" : ""}`}
              size="md"
              variant="default"
            />
          </div>
          ...
          <div className="mt-3">
            ...
            <Input
              ...
              className={`w-full px-2 py-1 border rounded-md ${missingFields.includes("email") ? "border-red-500" : ""}`}
              size="md"
              variant="default"
            />
          </div>
      ...
      {aiCategory !== "Unknown" && (
        <section className="p-2 mt-4 border rounded-md bg-gray-50">
