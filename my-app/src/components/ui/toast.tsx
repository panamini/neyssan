...
function variantClasses(variant?: ToastOptions["variant"]) {
  switch (variant) {
    ...
    case "warning":
      return "bg-accent text-background border-accent";
    default:
      return "bg-surface text-foreground border-accent";
  }
}
    ...
    >
      <div className="flex-1">
        <div className="flex items-center justify-between gap-2">
          ...
          <button aria-label="Dismiss toast" onClick={onClose} className="p-1 rounded focus:outline-none focus:ring-2 focus:ring-accent">
