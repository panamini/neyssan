/* eslint-disable @typescript-eslint/no-explicit-any, @typescript-eslint/no-unnecessary-type-assertion, @typescript-eslint/no-unsafe-argument, @typescript-eslint/no-unsafe-assignment, @typescript-eslint/no-unsafe-member-access -- Existing lint debt is captured locally for this release-gate baseline; fix these rules in focused follow-ups. */
    ...
    <div className="p-3 my-2 border [border-color:var(--color-border)] rounded [background:var(--sf1)]">
      <div className="flex items-center justify-between">
        <div>
          ...
          <div className="text-xs [color:var(--tm2)]">{section.blocks.length} blocks</div>
        </div>
        <div className="flex items-center gap-2">
          <button
            ...
            className="px-2 py-1 text-sm [background:var(--sf2)] rounded"
