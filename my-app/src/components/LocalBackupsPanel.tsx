    ...
    <div className="relative">
      ...
      {open && (
        <div
          ...
          className="absolute right-0 z-40 w-[320px] mt-2 p-3 bg-background border rounded-md shadow-lg border-accent"
        >
          ...
          <div className="space-y-2 overflow-auto max-h-72">
            {backups.length === 0 ? (
              ...
              backups.map((b) => (
                <div key={b.key} className="flex items-start justify-between p-2 border rounded-md bg-background/50">
