        ...
        <div className="p-4 space-y-4">
          <div className="flex items-center gap-4">
            ...
            <div className="flex flex-col gap-2">
              <label className="text-xs text-neutral-500" htmlFor="photoUrl">Photo URL</label>
              <input
                id="photoUrl"
                className="px-2 py-1 text-sm bg-transparent border rounded w-72"
                placeholder="https://..."
                value={form.photoUrl}
                onChange={(e) => handleChange("photoUrl", e.target.value)}
              />
              <div className="text-xs text-neutral-500">or upload a local image</div>
              <input
                type="file"
                accept="image/*"
                className="text-xs"
          ...
          <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
            <div className="md:col-span-2">
              <label className="text-xs text-neutral-500" htmlFor="name">Name</label>
              <input
                id="name"
            ...
            <div className="md:col-span-2">
              <label className="text-xs text-neutral-500" htmlFor="desiredPosition">Desired position</label>
            ...
            <div>
              <label className="text-xs text-neutral-500" htmlFor="phone">Phone</label>
              <div className="flex items-center gap-2">
            ...
            <div>
              <label className="text-xs text-neutral-500" htmlFor="linkedin">LinkedIn</label>
              <div className="flex items-center gap-2">
            ...
            <div>
              <label className="text-xs text-neutral-500" htmlFor="website">Website</label>
              <div className="flex items-center gap-2">
            ...
            <div className="md:col-span-2">
              <label className="text-xs text-neutral-500" htmlFor="location">Location</label>
              <div className="flex items-center gap-2">
