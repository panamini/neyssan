    ...
    <div className="p-3 bg-white border rounded dark:bg-slate-900">
      ...
      <div className="flex flex-wrap gap-2 mt-3">
        {skills.map((s, idx) => (
          <div
            key={`${s}-${idx}`}
            className="flex items-center px-2 py-1 space-x-2 text-sm bg-gray-100 border rounded dark:bg-slate-800 dark:border-slate-700"
            role="group"
            aria-label={`Skill ${s}`}
          >
            <input
      ...
      <div className="flex items-center mt-3 space-x-2">
        <input
          ...
          className="flex-grow px-2 py-1 bg-transparent border rounded focus:outline-none focus:ring-2 focus:ring-blue-500"
        />
        <button
          type="button"
