  ...
  return (
    <div className="p-2 border rounded">
      <div className="grid gap-2 md:grid-cols-2">
        <input value={title} onChange={(e) => setTitle(e.target.value)} placeholder="Title" className="px-2 py-1 text-sm border rounded" />
        <input value={company} onChange={(e) => setCompany(e.target.value)} placeholder="Company" className="px-2 py-1 text-sm border rounded" />
        <input value={startDate} onChange={(e) => setStartDate(e.target.value)} placeholder="Start date (YYYY-MM-DD)" className="px-2 py-1 text-sm border rounded" />
...
export function EducationAdder({ onAdd }: EducationAdderProps) {
  ...
  return (
    <div className="p-2 border rounded">
      <div className="grid gap-2 md:grid-cols-2">
        <input value={school} onChange={(e) => setSchool(e.target.value)} placeholder="School" className="px-2 py-1 text-sm border rounded" />
        <input value={degree} onChange={(e) => setDegree(e.target.value)} placeholder="Degree" className="px-2 py-1 text-sm border rounded" />
        <input value={fieldOfStudy} onChange={(e) => setFieldOfStudy(e.target.value)} placeholder="Field of study" className="px-2 py-1 text-sm border rounded" />
        <input value={startDate} onChange={(e) => setStartDate(e.target.value)} placeholder="Start date (YYYY-MM-DD)" className="px-2 py-1 text-sm border rounded" />
        <input value={endDate} onChange={(e) => setEndDate(e.target.value)} placeholder="End date (YYYY-MM-DD or empty)" className="px-2 py-1 text-sm border rounded" />
      </div>
      <div className="flex gap-2 mt-2">
