...
export function CVDocumentReviewer({
  ...
  return (
    ...
    >
      <header
        className="flex items-center justify-between px-4 py-3 border-b border-[var(--accent)] bg-[var(--background)]"
      ...
      >
        ...
        {sections.map((section) => (
          <article
            key={section.id}
            role="listitem"
            className="mb-6 rounded-md border border-[var(--accent)] bg-[var(--background)]"
            aria-hidden={section.dismissed ? "true" : "false"}
          >
            <div
              className="sticky top-0 z-10 flex items-center justify-between gap-4 px-4 py-2 bg-[var(--background)] border-b border-[var(--accent)]"
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                {section.dismissed && (
                  <button
                    className="px-2 py-1 rounded-md text-[var(--foreground)] bg-[var(--background)] border border-[var(--accent)] hover:bg-[var(--accent)]/5 focus:outline-none focus-visible:ring-2 focus-visible:ring-[var(--accent)]"
