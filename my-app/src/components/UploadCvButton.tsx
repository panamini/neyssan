...
export function UploadCvButton({
  ...
  // When using internal parser, UploadCvButton will forward parser results to the parent via onFileParsed.
  // When external parser is provided, the parent is expected to observe its own parser state and call onFileParsed itself.
  useEffect(() => {
