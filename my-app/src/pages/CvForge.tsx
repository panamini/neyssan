...
import { CvDocumentDisplay } from "../components/cv-display/CvDocumentDisplay";
          ...
          <Flex direction="column" gap="4" align="stretch" className="w-full">
            ...
            <div className="p-4 border rounded bg-background">
              <p className="text-sm text-muted-foreground">
                This workspace contains the CV library and editor. Use the sidebar to create or import CVs.
              </p>
            </div>
