...
volkregister: {
  id: "volkregister",
  label: "Volk Register",
  title: "Archival register resume",
  subtitle: "Historical civic letterhead logic translated into a resume with masthead, sender line, and disciplined register anchors",
  chips: ["Archival", "Register", "Letterhead"],
  margins: {
    top: "18mm",
    right: "18mm",
    bottom: "18mm",
  ...
  sidebarSection: {
    marginBottom: "4mm",
    titleMarginBottom: "1.4mm",
    titlePaddingBottom: "0.6mm",
    contentGap: "1.2mm",
  },
  mainSection: {
    marginBottom: "4.4mm",
    headingGap: "2mm",
    headingMarginBottom: "1.7mm",
  },
  experience: {
    dateColumn: "0mm",
    columnGap: "0mm",
