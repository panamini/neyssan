...
// convex/lib/parsing/llmPostProcessor.ts
...
function mapHeaderToField(headerRaw) {
  ...
  if (introKeys.some((k2) => cleaned.includes(k2))) return "introduction";
  ...
  if (experienceKeys.some((k2) => cleaned.includes(k2))) return "experience";
  const skillsKeys = [
    "skill",
    "skills",
    "competence",
  ...
  if (skillsKeys.some((k2) => cleaned.includes(k2))) return "skills";
  const educationKeys = [
    "education",
    "formation",
    "\xE9tudes",
  ...
  if (educationKeys.some((k2) => cleaned.includes(k2))) return "education";
  ...
  if (achievementsKeys.some((k2) => cleaned.includes(k2))) return "achievements";
  const languagesKeys = ["language", "languages", "langue", "langues", "langues parl\xE9es"];
  if (languagesKeys.some((k2) => cleaned.includes(k2))) return "languages";
  const contactKeys = [
    "contact",
    "coordonne",
    "coordonn\xE9es",
  ...
  if (contactKeys.some((k2) => cleaned.includes(k2))) return "contact";
  if (cleaned.includes("project") || cleaned.includes("projet") || cleaned.includes("projets")) return "projects";
  if (cleaned.includes("research") || cleaned.includes("recherche")) return "research";
  if (cleaned.includes("volunteer") || cleaned.includes("benevolat") || cleaned.includes("b\xE9n\xE9volat") || cleaned.includes("volontariat")) return "volunteer";
  if (cleaned.includes("reference") || cleaned.includes("r\xE9f\xE9rence") || cleaned.includes("r\xE9f\xE9rences")) return "references";
  if (cleaned.includes("autre") || cleaned.includes("divers") || cleaned.includes("other")) return "other";
  return "introduction";
}
function inferFieldFromContent(title, content, initial) {
  const lc = String(content || "").toLowerCase();
  const t2 = String(title || "").toLowerCase();
  if (/\b[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}\b/i.test(content) || /\+?\d{2,3}[\s.\-]?\d{1,4}/.test(content) || t2.includes("coordonn")) return "contact";
  if (/\b(19|20)\d{2}\b/.test(content) || /\bprésent\b/i.test(lc) || /\bpresent\b/i.test(lc) || /\b(ans|année|years)\b/i.test(lc) || /\b(agent|directeur|ingénieur|responsable|manager|chef|lead|consultant)\b/i.test(lc)) return "experience";
  if (/\b(universit|école|school|licence|master|mba|diplôm|bachelor)\b/i.test(content) || t2.includes("formation")) return "education";
  ...
  if (t2.includes("lang") || /\b(francais|français|anglais|english|espagnol|italien|german|allemand)\b/i.test(lc)) return "languages";
  if (t2.includes("projet") || t2.includes("project")) return "projects";
  if (t2.includes("recherche") || t2.includes("research")) return "research";
  return initial;
}
...
function parseLLMSections(text) {
  ...
  if (jsonFence) {
    ...
    if (parsedFence && typeof parsedFence === "object") {
      ...
      if (parsedFence.profile || parsedFence.summary || parsedFence.introduction) {
        ...
        if (p2.trim()) altSections.push({ title: "Introduction", content: p2.trim() });
      }
      if (Array.isArray(parsedFence.experience) && parsedFence.experience.length) {
        const body = parsedFence.experience.map((e2) => {
          const lines = [];
          if (e2.position || e2.title) lines.push(String(e2.position ?? e2.title));
          if (e2.company) lines.push(String(e2.company));
          if (e2.duration || e2.start || e2.end) lines.push(String(e2.duration ?? `${e2.start ?? ""} - ${e2.end ?? ""}`).trim());
          if (e2.responsibilities && Array.isArray(e2.responsibilities)) lines.push(e2.responsibilities.join("\n"));
      ...
      if (parsedFence.contact || parsedFence.contact_info || parsedFence.contactInfo) {
        ...
        let contactText = "";
        if (typeof c2 === "string") contactText = c2;
        else if (typeof c2 === "object") {
          const parts = [];
          if (c2.email) parts.push(String(c2.email));
          if (c2.phone) parts.push(String(c2.phone));
          if (c2.linkedin) parts.push(String(c2.linkedin));
      ...
      if (altSections.length === 0) {
        ...
        for (const k2 of Object.keys(parsedFence)) {
          if (candidateKeys.includes(k2)) continue;
  ...
  function simpleHeaderScan(fullText) {
    ...
    const isProbablyHeader = (line) => {
      ...
      if (/^[\p{Lu}\s0-9_-]{2,80}$/u.test(deaccent2(line)) && line.split(/\s+/).length <= 3) return true;
      return false;
    };
    for (let i2 = 0; i2 < lines.length; i2++) {
      const line = lines[i2];
...
// node_modules/openai/node_modules/webidl-conversions/lib/index.js
var require_lib = __commonJS({
  "node_modules/openai/node_modules/webidl-conversions/lib/index.js"(exports2, module2) {
    "use strict";
    var conversions = {};
...
// node_modules/openai/node_modules/whatwg-url/lib/utils.js
var require_utils = __commonJS({
  "node_modules/openai/node_modules/whatwg-url/lib/utils.js"(exports2, module2) {
    "use strict";
...
// node_modules/openai/node_modules/tr46/lib/mappingTable.json
var require_mappingTable = __commonJS({
  "node_modules/openai/node_modules/tr46/lib/mappingTable.json"(exports2, module2) {
...
// node_modules/openai/node_modules/tr46/index.js
var require_tr46 = __commonJS({
  "node_modules/openai/node_modules/tr46/index.js"(exports2, module2) {
    "use strict";
...
// node_modules/openai/node_modules/whatwg-url/lib/url-state-machine.js
var require_url_state_machine = __commonJS({
  "node_modules/openai/node_modules/whatwg-url/lib/url-state-machine.js"(exports2, module2) {
    "use strict";
    var punycode = require("punycode");
...
// node_modules/openai/node_modules/whatwg-url/lib/URL-impl.js
var require_URL_impl = __commonJS({
  "node_modules/openai/node_modules/whatwg-url/lib/URL-impl.js"(exports2) {
    "use strict";
...
// node_modules/openai/node_modules/whatwg-url/lib/URL.js
var require_URL = __commonJS({
  "node_modules/openai/node_modules/whatwg-url/lib/URL.js"(exports2, module2) {
    "use strict";
...
// node_modules/openai/node_modules/whatwg-url/lib/public-api.js
var require_public_api = __commonJS({
  "node_modules/openai/node_modules/whatwg-url/lib/public-api.js"(exports2) {
    "use strict";
...
// convex/lib/parsing/enhancedParser.ts
var FIELD_KEY_MAP = {
  experience: [
    "experience",
    "work history",
...
// convex/lib/parsing/metadataExtractor.ts
    ...
    () => {
      for (let i2 = 0; i2 < Math.min(5, lines.length); i2++) {
        ...
        if (words.length >= 2 && words.length <= 4) {
          ...
          if (allCapitalized) return lines[i2];
        }
      }
      return null;
    }
...
// convex/lib/parsing/llmValidator.ts
...
// convex/lib/parsing/llmPrompts.ts
  ...
  for (let i2 = 0; i2 < lines.length; i2++) {
    ...
    if (/(^|\W)(langues|languages|langue|language)(\W|$)/i.test(line)) {
      ...
      for (let j2 = i2 + 1; j2 < lines.length; j2++) {
        const l2 = lines[j2];
        if (!l2 || /^\s*$/.test(l2)) break;
        if (/^[A-Z \-]{2,}$/.test(l2.trim()) || /^[\s#]*[A-Za-zÀ-ÖØ-öø-ÿ0-9 \-]+:/.test(l2.trim())) break;
...
// convex/lib/parsing/hybridParser.ts
...
function detectLanguageIsFrench(text) {
  ...
  try {
    ...
    if (Array.isArray(langs) && langs.length) {
      for (const l2 of langs) {
        if (typeof l2 === "string" && /francais|français|french/i.test(l2)) return true;
      }
    }
  } catch {
  }
  ...
  for (const m2 of strongMarkers) if (lower.includes(m2)) return true;
  const weakMarkers = [
    "langues",
    "langue",
    "profil",
    ...
    let sanitizeProviderResponse2 = function(raw) {
      ...
      try {
        ...
        if (parsed && typeof parsed === "object") {
            ...
            for (const item of parsed.output) {
              ...
              if (Array.isArray(item.content) && item.content.length) {
                for (const c2 of item.content) {
                  ...
                  if (typeof c2 === "object") {
                    if (c2.json) return JSON.stringify(c2.json);
                    if (typeof c2.text === "string") {
                      const fence = /```(?:json)?\s*([\s\S]*?)```/i.exec(c2.text);
                      if (fence && fence[1]) return fence[1].trim();
                      return String(c2.text);
                    }
                    if (typeof c2.output_text === "string") return String(c2.output_text);
                  }
                }
              }
            }
          ...
          if (Array.isArray(parsed.sections) || (parsed.profile || parsed.experience || parsed.skills)) return JSON.stringify(parsed);
        }
      } catch {
      }
...
async function callOpenAIResponsesForRepair(prompt, text, opts) {
  ...
  try {
    ...
    if (OpenAI2) {
      ...
      try {
        ...
        const j3 = resp;
        if (Array.isArray(j3.choices) && j3.choices[0]?.message?.content) return String(j3.choices[0].message.content);
        if (j3.full_response && Array.isArray(j3.full_response.choices) && j3.full_response.choices[0]?.message?.content) return String(j3.full_response.choices[0].message.content);
        ...
        if (j3?.output?.[0]?.content?.[0]) {
          ...
          if (c2.json) return JSON.stringify(c2.json);
          if (c2.text) return String(c2.text);
          if (c2.output_text) return String(c2.output_text);
        }
        try {
  ...
  const j2 = await res.json();
  if (Array.isArray(j2.choices) && j2.choices[0]?.message?.content) return String(j2.choices[0].message.content);
  if (j2.full_response && Array.isArray(j2.full_response.choices) && j2.full_response.choices[0]?.message?.content) return String(j2.full_response.choices[0].message.content);
  const outputs = j2.output || j2.outputs || j2.output?.[0]?.content || j2.outputs?.[0]?.content;
  if (Array.isArray(outputs)) {
    for (const item of outputs) {
      if (item && typeof item === "object") {
